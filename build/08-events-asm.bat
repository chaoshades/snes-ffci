...
CALL :FXApply damcyan-to-bridge.asm
CALL :FXApply mist-to-canal.asm
CALL :FXApply overworld-encounter-tables-plugin.asm
CALL :FXApply encounter-tables-plugin-logic.asm
CALL :FXApply canon-to-canoe.asm
IF %ERRORLEVEL% EQU 0 (
  echo ROM patched.
  @pause
  goto :end
