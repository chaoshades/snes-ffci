...
CALL :FXApply hovercraft-to-ship.asm
CALL :FXApply encounters-vehicle.asm
CALL :FXApply enterprise-palette-fix.asm
CALL :FXApply falcon-palette-fix.asm
CALL :FXApply chocobo-to-canoe.asm
CALL :FXApply change-canoe-speed.asm
CALL :FXApply change-canoe-animation.asm
CALL :FXApply disable-chocobo-dismounting.asm
CALL :FXApply change-vehicle-music.asm
IF %ERRORLEVEL% EQU 0 (
  echo ROM patched.
  @pause
  goto :end
